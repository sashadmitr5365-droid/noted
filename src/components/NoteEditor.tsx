    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex-1 px-5 pt-6 pb-10">
        ...
        <textarea
          ...
          className="t-h1 block w-full resize-none overflow-hidden border-none bg-transparent text-white placeholder:text-white/40 focus:outline-none"
        />

        <div className="mt-2 flex items-center gap-2 text-[11px] uppercase tracking-[0.12em] text-white/55">
        ...
        <textarea
          ...
          rows={10}
          className="t-body mt-4 block w-full resize-none overflow-y-auto border-none bg-transparent leading-relaxed text-white/90 placeholder:text-white/30 focus:outline-none"
        />

        {/* Tags are configured in app settings, not in the editor. */}
            ...
            <div className="mt-1 flex items-center gap-2 rounded-2xl border border-dashed border-white/15 px-3 py-2.5">
              ...
              {newTask.trim() && (
                <button
                  ...
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-ink-950 shadow-[0_4px_12px_-4px_rgba(255,255,255,0.4)] transition-all active:scale-90 hover:bg-white/90"
                >
                  <svg
                    width={16}
                    height={16}
