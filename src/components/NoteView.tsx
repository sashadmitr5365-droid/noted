  ...
  return (
    <AppBackground>
      ...
      >
        ...
        >
          {/* Badge — OUTSIDE the card, above or below depending on position */}
          {showBadge && (
            <div
              className={`flex ${
                ...
                settings.badgePosition.startsWith("top") ? "mb-3" : "mt-3 order-2"
              }`}
            >
              <div className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-black/35 px-3 py-1.5 text-[10.5px] font-medium uppercase tracking-[0.18em] text-white/85 backdrop-blur-md">
          ...
          <div
            className={`relative ${showBadge && settings.badgePosition.startsWith("top") ? "order-1" : ""}`}
          >
          ...
          >
            ...
            {/* Card content — full width, no internal padding for badge */}
