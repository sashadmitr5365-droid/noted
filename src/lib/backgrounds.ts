...
export const BACKGROUNDS: BackgroundDef[] = [
  ...
  // ════════════════════════════════════════════════════════════════════
  // PREMIUM COMPLEX (8+ layers, conic + radial + repeating)
  // ════════════════════════════════════════════════════════════════════
  {
    // Aurora Borealis — multi-color curtain of light, slow drift, deep
    // tundra, distant horizon. Cool greens and violets in motion.
    id: "auroraBorealis",
    name: "Северное сияние",
    description: "Зелёно-фиолетовое полярное свечение",
    base: "#02060a",
    layers:
      // Curtain of light (conic, slowly rotated)
      "conic-gradient(from 200deg at 30% 25%, rgba(16,185,129,0.32) 0deg, transparent 80deg, transparent 280deg, rgba(139,92,246,0.28) 360deg), " +
      // High-altitude purple band
      "linear-gradient(180deg, transparent 0%, rgba(99,102,241,0.18) 20%, transparent 35%), " +
      // Mid-altitude green core
      "linear-gradient(180deg, transparent 0%, rgba(20,184,166,0.22) 35%, transparent 55%), " +
      // Foreground teal smear
      "radial-gradient(60% 50% at 50% 70%, rgba(45,212,191,0.20) 0%, transparent 70%), " +
      // Deep core glow
      "radial-gradient(45% 40% at 65% 60%, rgba(34,197,94,0.18) 0%, transparent 65%), " +
      // Sub-horizon pink rim
      "radial-gradient(80% 25% at 50% 100%, rgba(236,72,153,0.08) 0%, transparent 70%), " +
      // Stars (tiny stars via repeating radial)
  ...
  {
    // Velvet Smoke — layers of warm and cool vapor, multiple altitudes,
    // suggests a stage lit from below. Soft, theatrical, deep.
    id: "velvetSmoke",
    name: "Бархатный дым",
    description: "Многослойные тёплые и холодные пары",
    base: "#08060a",
    layers:
      // Cool base haze from below (blue)
      "radial-gradient(70% 50% at 30% 80%, rgba(56,189,248,0.18) 0%, transparent 60%), " +
      // Warm core (amber) rising from center
      "radial-gradient(55% 45% at 55% 50%, rgba(251,191,36,0.16) 0%, transparent 65%), " +
      // Purple twilight
      "radial-gradient(60% 50% at 75% 30%, rgba(168,85,247,0.14) 0%, transparent 65%), " +
      // Pink upper haze
      "radial-gradient(70% 45% at 35% 20%, rgba(244,114,182,0.12) 0%, transparent 65%), " +
      // Mid-density smoke
      "radial-gradient(80% 60% at 50% 60%, rgba(148,163,184,0.10) 0%, transparent 70%), " +
      // Soft cyan accent (low right)
      "radial-gradient(40% 35% at 80% 75%, rgba(34,211,238,0.14) 0%, transparent 65%), " +
      // Deep cool shadow
      "radial-gradient(45% 40% at 20% 35%, rgba(99,102,241,0.12) 0%, transparent 65%), " +
      // High warm highlight
      "linear-gradient(180deg, rgba(255,220,180,0.04) 0%, transparent 30%)",
    noise: true,
    vignette: true,
  },
  {
    // Cosmic Dust — deep space, galactic clouds, dust lanes, distant
    // stars, faint nebula glow. Very dark with rare warm cool accents.
    id: "cosmicDust",
    name: "Космическая пыль",
    description: "Галактические облака и пылевые слои",
    base: "#020308",
    layers:
      // Distant galaxy core (warm)
      "radial-gradient(40% 35% at 70% 35%, rgba(251,191,36,0.10) 0%, transparent 60%), " +
      // Nebula (cyan-violet)
      "radial-gradient(55% 45% at 30% 60%, rgba(99,102,241,0.16) 0%, rgba(168,85,247,0.08) 40%, transparent 70%), " +
      // Pink dust lane
      "radial-gradient(45% 40% at 50% 75%, rgba(236,72,153,0.10) 0%, transparent 60%), " +
      // Distant teal wisps
      "radial-gradient(35% 30% at 80% 80%, rgba(20,184,166,0.08) 0%, transparent 55%), " +
      // Deep space ambient
      "radial-gradient(100% 100% at 50% 50%, rgba(20,15,40,0.4) 0%, transparent 100%), " +
      // Pinpoint stars
      ...
      "radial-gradient(1px 1px at 65% 30%, rgba(255,255,255,0.6) 0%, transparent 100%), " +
      "radial-gradient(1px 1px at 85% 18%, rgba(255,255,255,0.4) 0%, transparent 100%), " +
  ...
  {
    // Bioluminescence — deep ocean, glowing organisms, cold teal
    // pressure, with hot bio-luminescent flecks drifting.
    id: "bioluminescence",
    name: "Биолюминесценция",
    description: "Глубоководные светящиеся организмы",
    base: "#02080a",
    layers:
      // Cold pressure from top
      "linear-gradient(180deg, rgba(13,148,136,0.12) 0%, transparent 35%), " +
      // Mid-water teal glow
      "radial-gradient(60% 50% at 50% 50%, rgba(20,184,166,0.18) 0%, transparent 65%), " +
      // Bio flash 1 (warm)
      "radial-gradient(20% 20% at 30% 40%, rgba(251,191,36,0.22) 0%, transparent 60%), " +
      // Bio flash 2 (warm)
      "radial-gradient(15% 15% at 70% 60%, rgba(34,211,238,0.20) 0%, transparent 60%), " +
      // Bio flash 3 (pink)
      "radial-gradient(12% 12% at 50% 80%, rgba(244,114,182,0.18) 0%, transparent 60%), " +
      // Background deep blue
      "radial-gradient(80% 70% at 50% 100%, rgba(15,23,42,0.6) 0%, transparent 70%), " +
      // Tiny drifting organisms
      "radial-gradient(2px 2px at 20% 30%, rgba(94,234,212,0.7) 0%, transparent 100%), " +
      "radial-gradient(2px 2px at 60% 25%, rgba(94,234,212,0.5) 0%, transparent 100%), " +
      "radial-gradient(2px 2px at 80% 45%, rgba(251,191,36,0.6) 0%, transparent 100%), " +
      "radial-gradient(2px 2px at 35% 70%, rgba(244,114,182,0.5) 0%, transparent 100%), " +
      "radial-gradient(2px 2px at 75% 85%, rgba(34,211,238,0.6) 0%, transparent 100%)",
    noise: true,
    vignette: true,
  },
  {
    // Magnetic Field — lines of force, dark vortices, the suggestion
    // of a force-field curving space. Cold and orderly, but alive.
    id: "magneticField",
    name: "Магнитное поле",
    description: "Линии напряжённости и тёмные вихри",
    base: "#02040a",
    layers:
      // Conic vortex (rotating force lines)
      "conic-gradient(from 0deg at 30% 50%, transparent 0deg, rgba(99,102,241,0.10) 60deg, transparent 120deg, rgba(168,85,247,0.10) 200deg, transparent 260deg, rgba(99,102,241,0.10) 340deg, transparent 360deg), " +
      // Second conic vortex (counter-rotating)
      "conic-gradient(from 180deg at 70% 50%, transparent 0deg, rgba(34,211,238,0.10) 60deg, transparent 120deg, rgba(99,102,241,0.08) 200deg, transparent 260deg, transparent 360deg), " +
      // Center force convergence
      "radial-gradient(40% 35% at 50% 50%, rgba(99,102,241,0.18) 0%, transparent 60%), " +
      // Cold outer void
      "radial-gradient(100% 100% at 50% 50%, rgba(2,4,12,0.5) 0%, transparent 100%), " +
      // Subtle horizontal field lines
      "linear-gradient(180deg, transparent 0%, rgba(99,102,241,0.05) 30%, transparent 60%, rgba(168,85,247,0.05) 80%, transparent 100%), " +
      // Glow at field-line convergence
      "radial-gradient(20% 15% at 50% 30%, rgba(167,139,250,0.18) 0%, transparent 60%), " +
      // Dark vortex shadow
      "radial-gradient(25% 25% at 50% 70%, rgba(0,0,0,0.5) 0%, transparent 65%), " +
      // Edge highlights (top + bottom hints)
      "linear-gradient(0deg, transparent 0%, rgba(99,102,241,0.06) 50%, transparent 100%)",
    noise: true,
    vignette: true,
  },
  // ════════════════════════════════════════════════════════════════════
  // MUTED / MONOCHROMATIC — quiet, atmospheric, no accents.
  // Each is a single hue family. All layers stay below 0.12 opacity.
  // ════════════════════════════════════════════════════════════════════
  {
    // Tundra — deep gray-blue, pre-dawn light. Cold, still, vast.
    id: "tundra",
    name: "Тундра",
    description: "Глубокий серо-голубой предрассветный",
    base: "#05080c",
    layers:
      "radial-gradient(80% 70% at 30% 25%, rgba(70,90,130,0.10) 0%, transparent 65%), " +
      "radial-gradient(70% 60% at 75% 70%, rgba(50,70,100,0.08) 0%, transparent 65%), " +
      "radial-gradient(60% 50% at 50% 50%, rgba(40,60,90,0.06) 0%, transparent 70%), " +
      "linear-gradient(180deg, rgba(20,30,50,0.08) 0%, transparent 50%, transparent 80%, rgba(0,0,0,0.3) 100%), " +
      "linear-gradient(90deg, transparent 0%, rgba(60,80,120,0.05) 50%, transparent 100%), " +
      "radial-gradient(50% 40% at 20% 80%, rgba(30,40,60,0.12) 0%, transparent 70%), " +
      "radial-gradient(45% 35% at 80% 20%, rgba(20,30,50,0.10) 0%, transparent 65%)",
    noise: true,
    vignette: true,
  },
  {
    // Cave — deep gray-brown, stone, damp air. Quiet, enclosing.
    id: "cave",
    name: "Пещера",
    description: "Глубокий серо-коричневый, каменный",
    base: "#07060a",
    layers:
      "radial-gradient(80% 70% at 35% 30%, rgba(90,75,70,0.10) 0%, transparent 65%), " +
      "radial-gradient(70% 60% at 70% 75%, rgba(60,50,45,0.08) 0%, transparent 65%), " +
      "radial-gradient(60% 50% at 50% 50%, rgba(50,42,40,0.06) 0%, transparent 70%), " +
      "linear-gradient(180deg, rgba(30,25,22,0.10) 0%, transparent 40%, transparent 60%, rgba(0,0,0,0.4) 100%), " +
      "radial-gradient(50% 40% at 20% 70%, rgba(40,35,30,0.12) 0%, transparent 70%), " +
      "radial-gradient(45% 35% at 85% 25%, rgba(35,28,25,0.10) 0%, transparent 65%), " +
      "linear-gradient(0deg, transparent 0%, rgba(50,40,35,0.04) 50%, transparent 100%)",
    noise: true,
    vignette: true,
  },
  {
    // Ember Ash — deep gray-orange, the day after a fire. Charred
    // but not glowing. Smoke-gray with a hint of warmth.
    id: "emberAsh",
    name: "Угольная зола",
    description: "Глубокий серо-оранжевый, после огня",
    base: "#0a0807",
    layers:
      "radial-gradient(80% 70% at 30% 30%, rgba(120,80,55,0.10) 0%, transparent 65%), " +
      "radial-gradient(70% 60% at 75% 70%, rgba(90,60,40,0.08) 0%, transparent 65%), " +
      "radial-gradient(60% 50% at 50% 50%, rgba(70,50,40,0.06) 0%, transparent 70%), " +
      "linear-gradient(180deg, rgba(40,28,20,0.08) 0%, transparent 50%, transparent 80%, rgba(0,0,0,0.3) 100%), " +
      "radial-gradient(50% 40% at 25% 75%, rgba(60,40,30,0.12) 0%, transparent 70%), " +
      "radial-gradient(45% 35% at 80% 20%, rgba(50,35,25,0.10) 0%, transparent 65%), " +
      "radial-gradient(35% 30% at 50% 100%, rgba(80,55,35,0.10) 0%, transparent 70%)",
    noise: true,
    vignette: true,
  },
  {
    // Moss Stone — deep gray-green, ancient moss, wet rock. Quiet,
    // slightly damp, no glow.
    id: "mossStone",
    name: "Мшистый камень",
    description: "Глубокий серо-зелёный, влажный камень",
    base: "#06080a",
    layers:
      "radial-gradient(80% 70% at 30% 25%, rgba(60,90,70,0.10) 0%, transparent 65%), " +
      "radial-gradient(70% 60% at 75% 75%, rgba(40,70,50,0.08) 0%, transparent 65%), " +
      "radial-gradient(60% 50% at 50% 50%, rgba(30,55,40,0.06) 0%, transparent 70%), " +
      "linear-gradient(180deg, rgba(20,30,22,0.10) 0%, transparent 50%, transparent 80%, rgba(0,0,0,0.3) 100%), " +
      "radial-gradient(50% 40% at 20% 80%, rgba(30,50,38,0.12) 0%, transparent 70%), " +
      "radial-gradient(45% 35% at 85% 20%, rgba(25,45,32,0.10) 0%, transparent 65%), " +
      "linear-gradient(90deg, transparent 0%, rgba(40,60,45,0.04) 50%, transparent 100%)",
    noise: true,
    vignette: true,
  },
  {
    // Twilight Dust — deep gray-violet, the last 20 minutes of
    // daylight, the sky drained of color. Almost monochrome violet.
    id: "twilightDust",
    name: "Сумерки",
    description: "Глубокий серо-фиолетовый, последний свет",
    base: "#06050a",
    layers:
      "radial-gradient(80% 70% at 30% 25%, rgba(75,60,110,0.10) 0%, transparent 65%), " +
      "radial-gradient(70% 60% at 75% 75%, rgba(55,45,85,0.08) 0%, transparent 65%), " +
      "radial-gradient(60% 50% at 50% 50%, rgba(45,38,70,0.06) 0%, transparent 70%), " +
      "linear-gradient(180deg, rgba(25,20,40,0.10) 0%, transparent 50%, transparent 80%, rgba(0,0,0,0.3) 100%), " +
      "radial-gradient(50% 40% at 20% 75%, rgba(40,30,60,0.12) 0%, transparent 70%), " +
      "radial-gradient(45% 35% at 80% 20%, rgba(35,28,55,0.10) 0%, transparent 65%), " +
      "linear-gradient(45deg, transparent 0%, rgba(50,40,80,0.05) 60%, transparent 100%)",
    noise: true,
    vignette: true,
  },
];
