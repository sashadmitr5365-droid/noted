...
export const BACKGROUNDS: BackgroundDef[] = [
  ...
  },
  {
    id: "aurora",
    name: "Аврора",
    description: "Зелёно-фиолетовое северное сияние",
    base: "#040a08",
    layers:
      "radial-gradient(40% 40% at 20% 30%, rgba(16,185,129,0.32) 0%, rgba(0,0,0,0) 65%), radial-gradient(45% 45% at 80% 25%, rgba(139,92,246,0.30) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 50% at 50% 90%, rgba(59,130,246,0.18) 0%, rgba(0,0,0,0) 65%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#04080f",
    layers:
      "radial-gradient(60% 50% at 50% 0%, rgba(100,116,139,0.28) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 20% 80%, rgba(148,163,184,0.20) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 80% 90%, rgba(203,213,225,0.14) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    id: "horizon",
    name: "Горизонт",
    description: "Тёплый закат над водой",
    base: "#0a0612",
    layers:
      "radial-gradient(60% 50% at 50% 100%, rgba(251,146,60,0.30) 0%, rgba(0,0,0,0) 60%), radial-gradient(50% 45% at 30% 30%, rgba(244,63,94,0.22) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 70% 20%, rgba(168,85,247,0.16) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#060c08",
    layers:
      "radial-gradient(60% 55% at 30% 25%, rgba(132,204,22,0.22) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 75% 80%, rgba(101,163,13,0.16) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 50% 50%, rgba(190,242,100,0.08) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#0c0408",
    layers:
      "radial-gradient(60% 55% at 30% 25%, rgba(220,38,38,0.26) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 75% 80%, rgba(159,18,57,0.20) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 50% 50%, rgba(244,63,94,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#0a0a0e",
    layers:
      "radial-gradient(50% 45% at 30% 30%, rgba(226,232,240,0.18) 0%, rgba(0,0,0,0) 60%), radial-gradient(45% 40% at 70% 70%, rgba(203,213,225,0.14) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 35% at 50% 50%, rgba(241,245,249,0.08) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    id: "void",
    name: "Пустота",
    description: "Абсолютная чернота с лёгким дыханием",
    base: "#000000",
    layers:
      "radial-gradient(80% 60% at 50% 50%, rgba(20,20,28,0.5) 0%, rgba(0,0,0,0) 70%), radial-gradient(30% 30% at 50% 50%, rgba(40,40,55,0.3) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#02081a",
    layers:
      "radial-gradient(60% 55% at 30% 25%, rgba(37,99,235,0.32) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 75% 80%, rgba(14,165,233,0.22) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 50% 50%, rgba(96,165,250,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#0c0610",
    layers:
      "radial-gradient(60% 55% at 30% 25%, rgba(251,113,133,0.26) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 75% 80%, rgba(251,191,36,0.20) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 50% 50%, rgba(244,114,182,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#04080a",
    layers:
      "radial-gradient(50% 45% at 30% 30%, rgba(20,83,45,0.30) 0%, rgba(0,0,0,0) 65%), radial-gradient(45% 40% at 70% 70%, rgba(6,78,59,0.22) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 35% at 50% 50%, rgba(34,197,94,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#04081a",
    layers:
      "radial-gradient(60% 55% at 30% 25%, rgba(30,58,138,0.28) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 75% 80%, rgba(67,56,202,0.20) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 50% 50%, rgba(99,102,241,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#0e0810",
    layers:
      "radial-gradient(50% 45% at 30% 30%, rgba(244,114,182,0.22) 0%, rgba(0,0,0,0) 65%), radial-gradient(45% 40% at 70% 70%, rgba(217,70,239,0.16) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 35% at 50% 50%, rgba(249,168,212,0.08) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    description: "Лёгкая и тонкая подсветка",
    base: "#0a0a0e",
    layers:
      "radial-gradient(80% 60% at 50% 50%, rgba(139,92,246,0.16) 0%, rgba(0,0,0,0) 60%), radial-gradient(50% 45% at 25% 25%, rgba(59,130,246,0.10) 0%, rgba(0,0,0,0) 65%)",
    noise: true,
    vignette: true,
  },
  {
    ...
    base: "#02151a",
    layers:
      "radial-gradient(55% 50% at 50% 0%, rgba(13,148,136,0.26) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 20% 80%, rgba(6,95,70,0.22) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 35% at 80% 90%, rgba(20,184,166,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
  {
    id: "verdant",
    name: "Изумрудный шторм",
    description: "Тёмный изумруд",
    base: "#020c08",
    layers:
      "radial-gradient(60% 55% at 30% 25%, rgba(5,150,105,0.28) 0%, rgba(0,0,0,0) 65%), radial-gradient(50% 45% at 75% 80%, rgba(16,185,129,0.20) 0%, rgba(0,0,0,0) 65%), radial-gradient(40% 40% at 50% 50%, rgba(52,211,153,0.10) 0%, rgba(0,0,0,0) 70%)",
    noise: true,
    vignette: true,
  },
];
